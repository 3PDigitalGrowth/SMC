...
const team = [
  ...
  },
  {
    ...
    bio: 'General practice, with particular interests in family law, medical negligence, intellectual property, and corporate and commercial matters. With the firm since 2023.',
    fullBio: [
      ...
      'During her time at the firm, she has developed experience across general practice matters, including file management, client communication, legal research, and the preparation of court documents and correspondence. She practises across all areas of general practice, with particular interests in family law, medical negligence, intellectual property, and corporate and commercial matters. Mahima also holds a Master of Business Administration (MBA) from Canada, which adds valuable commercial insight when advising business clients.',
