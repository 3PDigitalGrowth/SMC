  ...
  return (
    <>
      ...
      <PageHero
        ...
        lede="A short guide written by a Gawler family lawyer of 36 years. The 12-month rule, the timeline, the parts that catch people out, and what you can actually do right now."
