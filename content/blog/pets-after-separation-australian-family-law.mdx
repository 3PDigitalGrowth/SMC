...
Where communication remains possible, [family mediation](https://www.stevenmclark.com.au/family-mediation) can address the animal alongside property, communication and implementation issues. A mediator helps the parties test options but does not impose a decision.
...
Pet ownership may also affect a broader [property settlement](https://www.stevenmclark.com.au/property-settlement). The financial value of an ordinary family pet may be modest, but legal costs and emotional conflict can become disproportionate if the issue is not isolated early.
...
The first task is not necessarily to start proceedings. It may be to send a precise proposal, secure records, document an interim arrangement or include the pet within broader negotiations. Our [family law services](https://www.stevenmclark.com.au/family) can assist with that assessment.
...
For advice about pets after separation in Australia, [contact Steven M Clark Lawyers](https://www.stevenmclark.com.au/contact). Bring the acquisition records, registration details, veterinary history, relevant messages and a short chronology to the initial discussion.
