...
export const IMAGES = {
  ...
  bioSteven: {
    src: '/images/bio-steven.jpg',
    alt: 'Steven M Clark, Principal Solicitor and Public Notary',
    caption: 'Steven M Clark. Principal Solicitor and Public Notary.',
    prompt: `Real client-supplied studio portrait. Do not regenerate.`,
    aspect: '3:4',
  },
  bioZahra: {
    src: '/images/bio-zahra.jpg',
    alt: 'Zahra Amin, Solicitor',
    caption: 'Zahra Amin. Solicitor.',
    prompt: `Real client-supplied studio portrait. Do not regenerate.`,
    aspect: '3:4',
  },
  bioJack: {
    src: '/images/bio-jack.jpg',
    alt: 'Jack Clark, Solicitor',
    caption: 'Jack Clark. Solicitor.',
    prompt: `Real client-supplied studio portrait. Do not regenerate.`,
    aspect: '3:4',
  },
  bioMahima: {
